# The name of this view in Looker is "Airflow Worker"
view: airflow_worker {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ntt-data-argentina-macro.logs_composer.airflow_worker`
    ;;
  ...
  dimension: labels__execution_date {
    type: string
    sql: ${TABLE}.labels.execution_date ;;
    group_label: "Labels"
    group_item_label: "Execution Date"
  }
  ...
  dimension: labels__task_id {
    type: string
    sql: ${TABLE}.labels.task_id ;;
    group_label: "Labels"
    group_item_label: "Task ID"
  }

  dimension: labels__try_number {
    type: string
    sql: ${TABLE}.labels.try_number ;;
    group_label: "Labels"
    group_item_label: "Try Number"
  }

  dimension: labels__worker_id {
    type: string
    sql: ${TABLE}.labels.worker_id ;;
    group_label: "Labels"
    group_item_label: "Worker ID"
  }

  dimension: labels__workflow {
    type: string
    sql: ${TABLE}.labels.workflow ;;
    group_label: "Labels"
    group_item_label: "Workflow"
  }
